...
const DisplacementSphere = (props) => {
    ...
    useEffect(() => {
        const dirLight = new DirectionalLight(
            rgbToThreeColor("200 200 200"), // Gris claro
            0.6
        );
    
        // Luz ambiental (gris oscuro)
        const ambientLight = new AmbientLight(
            rgbToThreeColor("60 60 60"), // Gris oscuro
            theme === "light" ? 0.8 : 0.1 // Intensidad variable según el tema
        );
